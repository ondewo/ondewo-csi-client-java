...
class BearerTokenTest {
    ...
    void attachToReturnsAnAuthenticatedCopyOfEveryStubFlavour() {
        ...
        final BearerToken token = new BearerToken("s3cr3t");
        final ConversationsGrpc.ConversationsBlockingStub blocking =
                ConversationsGrpc.newBlockingStub(channel);
        final ConversationsGrpc.ConversationsFutureStub future =
                ConversationsGrpc.newFutureStub(channel);
        final ConversationsGrpc.ConversationsStub async = ConversationsGrpc.newStub(channel);

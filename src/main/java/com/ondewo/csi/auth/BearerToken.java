 ...
 * ({@code com.ondewo.nlu}, {@code ondewo.csi}, {@code ondewo.nlu}, {@code ondewo.s2t},
 * {@code ondewo.t2s}), and anything sitting in a sibling package such as this one survives a
 ...
 * ConversationsGrpc.ConversationsBlockingStub stub =
 *     new BearerToken(accessToken).attachTo(ConversationsGrpc.newBlockingStub(channel));
 * }</pre>
 */
